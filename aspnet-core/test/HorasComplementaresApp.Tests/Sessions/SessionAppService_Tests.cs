...
using Shouldly;
using Xunit;
using HorasComplementaresApp.Sessions;

namespace HorasComplementaresApp.Tests.Sessions
{
    public class SessionAppService_Tests : HorasComplementaresAppTestBase
    {
