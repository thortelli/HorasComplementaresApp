...
using Abp.UI;
using HorasComplementaresApp.Authentication.External;
...
using HorasComplementaresApp.Models.TokenAuth;
using HorasComplementaresApp.MultiTenancy;

namespace HorasComplementaresApp.Controllers
{
    [Route("api/[controller]/[action]")]
    public class TokenAuthController : HorasComplementaresAppControllerBase
    {
